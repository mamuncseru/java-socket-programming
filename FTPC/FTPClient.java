...
class activity{
    ...
    private String address="F:/3rd year 1st semester/Computer networking/FTP/FTPC/";
    public activity(Socket soc){
     ...
     void getIndex()throws Exception{
         ...
         System.out.println("Shwoing txt file of server.");
         if(len==0){
     ...
     public void sendFile(String address) throws Exception{
        ...
        if(!f.exists()){
            System.out.println("File doesnot exist: "+fileName);
            return;
        }

        //making contact NOW
        dout.writeUTF("RECIEVE");
        dout.writeUTF(fileName);

        String feedback = din.readUTF();
        
        if(feedback.equals("exist")){
            System.out.print("\nServer already ontains the file: "+
